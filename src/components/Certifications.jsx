...
export default function Certifications() {
    return (
        <section id="certifications" className="glow-card p-8 relative overflow-hidden group">
            {/* Background */}
            <div className="absolute top-0 right-0 w-36 h-36 bg-emerald-500/5 rounded-full blur-[80px] pointer-events-none" />
            ...
            <div className="space-y-3 relative">
                {CERTIFICATIONS.map((cert, i) => (
                    <motion.div
                        ...
                        className="relative p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-indigo-500/25 hover:bg-white/[0.04] transition-all group/cert"
                    >
                        <div className="flex items-start justify-between gap-3">
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1">
                                    <span className="text-[9px] font-mono font-black text-indigo-400 uppercase tracking-wider">
                                        {cert.issuer}
                                    </span>
                            ...
                            <div className="shrink-0 mt-1">
                                <CheckCircle2 size={14} className="text-emerald-500/40 group-hover/cert:text-emerald-400 transition-colors" />
                            </div>
                        </div>
