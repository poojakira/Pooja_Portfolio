...
export const getResponse = (input, options = {}) => {
    ...
    // Final fallback
    const response = `I wasn't sure exactly what you meant, but I'll try to help! Pooja Kiran is a Graduate MLOps Engineer with expertise in:
